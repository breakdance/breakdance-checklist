# Contributing to breakdance-checklist

First and foremost, thank you! We appreciate that you want to contribute to breakdance-checklist, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for breakdance-checklist**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for breakdance-checklist:

- star the [project](https://github.com/jonschlinkert/breakdance-checklist)
- tweet your support for breakdance-checklist
...
- **version**: please note the version of breakdance-checklist are you using
...
[so]: http://stackoverflow.com/questions/tagged/breakdance-checklist